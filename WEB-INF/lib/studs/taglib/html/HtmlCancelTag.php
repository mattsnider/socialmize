<?php
/* $Id: HtmlCancelTag.php 188 2005-04-07 04:52:31Z mojavelinux $
 *
 ...
 * @author Dan Allen
 */
class HtmlCancelTag extends BaseInteractiveTag
{
	var $value = null;
	...
	function renderTag()
	{
		$xhtml = '<input type="submit" name="' . c('StudsConstants::CANCEL_PARAM') . '" value="' . $this->label . '"';
