<?php
/* $Id: PgSQLPreparedStatement.php 324 2006-03-11 05:42:59Z mojavelinux $
 *
 ...
 */
class PgSQLPreparedStatement extends PreparedStatement
{
	...
	function setString($paramIndex, $value)
	{
		...
		$this->parameterValues[$paramIndex - 1] = '\'' . pg_escape_string($value) . '\'';	
	}
