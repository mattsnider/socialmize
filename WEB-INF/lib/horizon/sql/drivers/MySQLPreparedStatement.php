...
class MySQLPreparedStatement extends PreparedStatement {
	...
	/**
	 * This is an attempt to cache repeated queries.
	 *
	 * @property Array
	 * @private
	 */
	...
	function setArray($paramIndex, $value) {
		// TODO: make sure not out of range, etc
		$this->parameterValues[$paramIndex - 1] = sizeof($value) ? implode(',', $value) : '';
	}
	...
	function setDirectly($paramIndex, $value) {
		// TODO: make sure not out of range, etc
		$this->parameterValues[$paramIndex - 1] = $value;
	}

	function setNULL($paramIndex, $value) {
		// TODO: make sure not out of range, etc
		$this->parameterValues[$paramIndex - 1] = 'NULL';
	}
	...
	function &execSQL($sql, $update = false) {
		$logger =& Logger::getLogger('horizon.sql.drivers.MySQLPreparedStatement');
		$logger->warn("\n" . $sql);
		$result = mysql_query($sql);
		// TODO: why do delete statements not return a reference? -mes
