...
FormElement = {
	...
	getValue: function(element) {
		var method = element.get('tagName').toLowerCase(),
			parameter = FormElementSerializer[method](element);
...
FormElementSerializer = {
	...
	input: function(element) {
		switch (element.get('type')) {
			case 'checkbox':
			case 'radio':
				return FormElementSerializer.inputSelector(element);
			default:
				return FormElementSerializer.textarea(element);
		}
	},
	...
	select: function(element) {
		return FormElementSerializer['select-one' === element.get('type') ? 'selectOne' : 'selectMany'](element);
	},
...
Y.FormElement = FormElement;
Y.FormElementSerializer = FormElementSerializer;
